# Laravel REST Processor 🚀

[![Latest Version on Packagist](https://img.shields.io/packagist/v/warrior/rest-processor.svg?style=flat-square)](https://packagist.org/packages/warrior/rest-processor)
[![Tests Passing](https://img.shields.io/badge/tests-passing-brightgreen.svg?style=flat-square)](#)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg?style=flat-square)](LICENSE.md)

Un procesador declarativo, fluido y de alto rendimiento para consultas REST en **Laravel 10, 11 y 12** sobre **Eloquent ORM**.

Diseñado para eliminar el código repetitivo en controladores CRUD y proporcionar una experiencia de desarrollo de primer nivel (**Developer Experience - DX First**), permitiendo que componentes de filtrado en el frontend (React, Vue, Inertia, Angular, Svelte) consulten datos mediante APIs REST limpias, predecibles y seguras.
...
- **Macro Ultraligera de Eloquent:** Usa `Model::processRest()` o `RestProcessor::for(Model::class)`.
...
```bash
composer require warrior/rest-processor
```

Opcionalmente, puedes publicar el archivo de configuración:

```bash
php artisan vendor:publish --tag="rest-processor-config"
```
...
### Opción A: Sintaxis Fluida con `RestProcessor::for()`
...
use Warrior\RestProcessor\Filters\Filter;
...
class UserController extends Controller
{
    ...
    {
        return RestProcessor::for(User::class, $request)
