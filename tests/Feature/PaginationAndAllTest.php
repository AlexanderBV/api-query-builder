...
use Warrior\ApiQueryBuilder\Tests\Fixtures\Resources\UserResource;
...
final class PaginationAndAllTest extends TestCase
{
    ...
    public function it_rejects_all_true_when_allow_all_is_not_enabled(): void
    {
        ...
        // when
        ApiQueryBuilder::for(User::class, $request)->get();
    }
    ...
    public function it_returns_flat_array_when_all_true_is_allowed(): void
    {
        ...
        $processor = ApiQueryBuilder::for(User::class, $request)->allowAll();
    ...
    public function it_formats_all_true_collection_with_api_resource(): void
    {
        ...
        // when
        $response = ApiQueryBuilder::for(User::class, $request)
            ->allowAll()
    ...
    /**
     * Escenario: Uso de la Macro registrada en Eloquent (User::apiQuery()).
     * Expectativa: Funciona de forma idéntica a ApiQueryBuilder::for(User::class).
     */
    #[Test]
