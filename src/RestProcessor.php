...
use Warrior\RestProcessor\Context\ProcessorConfig;
...
use Warrior\RestProcessor\Pipes\FilterPipe;
use Warrior\RestProcessor\Pipes\IncludePipe;
use Warrior\RestProcessor\Pipes\PaginationPipe;
use Warrior\RestProcessor\Pipes\SearchPipe;
use Warrior\RestProcessor\Pipes\SortPipe;
...
final class RestProcessor
{
    ...
    public function __construct(Builder $builder, ?Request $request = null)
    {
        ...
        $appConfig = config('rest-processor', []);
    ...
    public static function for(mixed $subject, ?Request $request = null): self
    {
        ...
        throw new InvalidArgumentException(
            'RestProcessor::for() solo acepta un class-string de Eloquent Model, un Builder o una Relation.'
        );
    }
